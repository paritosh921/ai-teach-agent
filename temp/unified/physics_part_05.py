...
The generator injects a JSON list into [{"type": "title", "text": "Common Forces: Understanding Interactions"}, {"type": "bullets", "title": "Objectives", "items": ["Understand the relationship between force, mass, and acceleration.", "Comprehend Newton's Third Law and its implications.", "Identify action-reaction force pairs and their characteristics."]}, {"type": "two_column", "left_title": "Force", "left": "A vector quantity that causes an object to accelerate. Greater force results in greater acceleration.", "right_title": "Mass", "right": "A measure of an object's resistance to acceleration when a force is applied."}, {"type": "equation", "title": "Newton's Second Law", "lines": ["F = ma"]}, {"type": "bullets", "title": "Key Concepts", "items": ["Force: A vector quantity causing acceleration.", "Mass: Resistance to acceleration.", "Newton's Third Law: Action-reaction pairs."]}, {"type": "figure", "title": "Action-Reaction Forces", "caption": "Illustration of Newton's Third Law with interacting objects."}, {"type": "bar", "title": "Force vs. Acceleration", "labels": ["Low Mass", "High Mass"], "values": [10, 5]}, {"type": "plot", "title": "Force and Acceleration Relationship", "expr": "F = m * a", "x_range": [0, 10, 1], "y_range": [0, 100, 10]}, {"type": "bullets", "title": "Summary", "items": ["Newton's Third Law explains force interactions.", "Recognizing force pairs is crucial for analysis.", "Essential for solving real-world problems."]}] at build time.
"""
...
class Lesson(Scene):
    def construct(self):
        slides = [{"type": "title", "text": "Common Forces: Understanding Interactions"}, {"type": "bullets", "title": "Objectives", "items": ["Understand the relationship between force, mass, and acceleration.", "Comprehend Newton's Third Law and its implications.", "Identify action-reaction force pairs and their characteristics."]}, {"type": "two_column", "left_title": "Force", "left": "A vector quantity that causes an object to accelerate. Greater force results in greater acceleration.", "right_title": "Mass", "right": "A measure of an object's resistance to acceleration when a force is applied."}, {"type": "equation", "title": "Newton's Second Law", "lines": ["F = ma"]}, {"type": "bullets", "title": "Key Concepts", "items": ["Force: A vector quantity causing acceleration.", "Mass: Resistance to acceleration.", "Newton's Third Law: Action-reaction pairs."]}, {"type": "figure", "title": "Action-Reaction Forces", "caption": "Illustration of Newton's Third Law with interacting objects."}, {"type": "bar", "title": "Force vs. Acceleration", "labels": ["Low Mass", "High Mass"], "values": [10, 5]}, {"type": "plot", "title": "Force and Acceleration Relationship", "expr": "F = m * a", "x_range": [0, 10, 1], "y_range": [0, 100, 10]}, {"type": "bullets", "title": "Summary", "items": ["Newton's Third Law explains force interactions.", "Recognizing force pairs is crucial for analysis.", "Essential for solving real-world problems."]}]  # list[dict] injected by generator

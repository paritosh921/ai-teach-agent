...
The generator injects a JSON list into [{"type": "title", "text": "Common Forces in Physics"}, {"type": "bullets", "title": "Objectives", "items": ["Understand the relationship between force, mass, and acceleration.", "Comprehend Newton's Third Law and its implications.", "Apply these concepts to solve basic physics problems."]}, {"type": "two_column", "left_title": "Force", "left": "A vector quantity that causes an object to accelerate. Greater force results in greater acceleration.", "right_title": "Mass", "right": "A measure of an object's resistance to acceleration when a force is applied. Greater mass results in less acceleration for the same force."}, {"type": "equation", "title": "Newton's Second Law", "lines": ["F = ma"]}, {"type": "bullets", "title": "Key Concepts", "items": ["Force: Causes acceleration.", "Mass: Resistance to acceleration.", "Newton's Third Law: Action-reaction pairs."]}, {"type": "two_column", "left_title": "Newton's Third Law", "left": "For every action, there is an equal and opposite reaction.", "right_title": "Implications", "right": "Forces always come in pairs acting on different objects."}, {"type": "plot", "title": "Force vs. Acceleration", "expr": "F/m", "x_range": [0, 10, 0.1], "y_range": [0, 10, 0.1]}, {"type": "bar", "title": "Mass and Acceleration", "labels": ["1 kg", "2 kg", "3 kg"], "values": [10, 5, 3.33]}, {"type": "figure", "title": "Action-Reaction Example", "caption": "A swimmer pushes against the water, propelling forward."}, {"type": "bullets", "title": "Summary", "items": ["Explored force, mass, and acceleration.", "Discussed Newton's Third Law.", "Foundational principles in motion."]}] at build time.
"""
...
class Lesson(Scene):
    def construct(self):
        slides = [{"type": "title", "text": "Common Forces in Physics"}, {"type": "bullets", "title": "Objectives", "items": ["Understand the relationship between force, mass, and acceleration.", "Comprehend Newton's Third Law and its implications.", "Apply these concepts to solve basic physics problems."]}, {"type": "two_column", "left_title": "Force", "left": "A vector quantity that causes an object to accelerate. Greater force results in greater acceleration.", "right_title": "Mass", "right": "A measure of an object's resistance to acceleration when a force is applied. Greater mass results in less acceleration for the same force."}, {"type": "equation", "title": "Newton's Second Law", "lines": ["F = ma"]}, {"type": "bullets", "title": "Key Concepts", "items": ["Force: Causes acceleration.", "Mass: Resistance to acceleration.", "Newton's Third Law: Action-reaction pairs."]}, {"type": "two_column", "left_title": "Newton's Third Law", "left": "For every action, there is an equal and opposite reaction.", "right_title": "Implications", "right": "Forces always come in pairs acting on different objects."}, {"type": "plot", "title": "Force vs. Acceleration", "expr": "F/m", "x_range": [0, 10, 0.1], "y_range": [0, 10, 0.1]}, {"type": "bar", "title": "Mass and Acceleration", "labels": ["1 kg", "2 kg", "3 kg"], "values": [10, 5, 3.33]}, {"type": "figure", "title": "Action-Reaction Example", "caption": "A swimmer pushes against the water, propelling forward."}, {"type": "bullets", "title": "Summary", "items": ["Explored force, mass, and acceleration.", "Discussed Newton's Third Law.", "Foundational principles in motion."]}]  # list[dict] injected by generator

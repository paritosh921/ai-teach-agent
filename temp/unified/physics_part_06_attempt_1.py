...
The generator injects a JSON list into [{"type": "title", "text": "Work and Energy: Fundamental Concepts"}, {"type": "bullets", "title": "Objectives", "items": ["Understand the concept of work and its relation to force and displacement.", "Differentiate between types of forces and their roles in work.", "Apply the work-energy principle in physics problems."]}, {"type": "two_column", "left_title": "Work", "left": "Work is done when a force causes an object to move in the direction of the force.", "right_title": "Energy", "right": "Energy is the capacity to do work, existing in forms like kinetic, potential, and thermal."}, {"type": "equation", "title": "Work Formula", "lines": ["W = F \\cdot d = Fd \\cos \\theta"]}, {"type": "bullets", "title": "Key Concepts", "items": ["Work: Product of force and displacement in force's direction.", "Energy: Capacity to do work; exists in various forms."]}, {"type": "plot", "title": "Work vs. Displacement", "expr": "F * d * cos(theta)", "x_range": [0, 10, 0.1], "y_range": [0, 100, 1]}, {"type": "bar", "title": "Types of Energy", "labels": ["Kinetic", "Potential", "Thermal"], "values": [30, 40, 20]}, {"type": "figure", "title": "Force and Displacement", "caption": "Illustration of force applied to an object causing displacement."}, {"type": "bullets", "title": "Summary", "items": ["Work and energy describe force-induced motion and energy transfer.", "Essential for understanding complex physical systems."]}] at build time.
"""
...
class Lesson(Scene):
    def construct(self):
        slides = [{"type": "title", "text": "Work and Energy: Fundamental Concepts"}, {"type": "bullets", "title": "Objectives", "items": ["Understand the concept of work and its relation to force and displacement.", "Differentiate between types of forces and their roles in work.", "Apply the work-energy principle in physics problems."]}, {"type": "two_column", "left_title": "Work", "left": "Work is done when a force causes an object to move in the direction of the force.", "right_title": "Energy", "right": "Energy is the capacity to do work, existing in forms like kinetic, potential, and thermal."}, {"type": "equation", "title": "Work Formula", "lines": ["W = F \\cdot d = Fd \\cos \\theta"]}, {"type": "bullets", "title": "Key Concepts", "items": ["Work: Product of force and displacement in force's direction.", "Energy: Capacity to do work; exists in various forms."]}, {"type": "plot", "title": "Work vs. Displacement", "expr": "F * d * cos(theta)", "x_range": [0, 10, 0.1], "y_range": [0, 100, 1]}, {"type": "bar", "title": "Types of Energy", "labels": ["Kinetic", "Potential", "Thermal"], "values": [30, 40, 20]}, {"type": "figure", "title": "Force and Displacement", "caption": "Illustration of force applied to an object causing displacement."}, {"type": "bullets", "title": "Summary", "items": ["Work and energy describe force-induced motion and energy transfer.", "Essential for understanding complex physical systems."]}]  # list[dict] injected by generator

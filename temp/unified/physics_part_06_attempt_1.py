...
The generator injects a JSON list into [{"type": "title", "text": "Work and Energy: Fundamental Concepts"}, {"type": "bullets", "title": "Objectives", "items": ["Understand the concept of work and its relation to force and displacement.", "Differentiate between types of forces and their roles in work.", "Apply the work-energy principle in mechanics."]}, {"type": "two_column", "left_title": "Work", "left": "Work is done when a force causes an object to move in the direction of the force.", "right_title": "Energy", "right": "Energy is the capacity to do work."}, {"type": "bullets", "title": "Key Concepts", "items": ["Work: Force causing movement.", "Energy: Capacity to do work.", "Force: Push or pull causing acceleration."]}, {"type": "equation", "title": "Work Formula", "lines": ["W = F \\cdot d = Fd \\cos \\theta"]}, {"type": "figure", "title": "Force and Displacement", "caption": "Illustration of force applied at an angle to displacement."}, {"type": "bar", "title": "Types of Forces", "labels": ["Gravitational", "Frictional", "Applied", "Normal"], "values": [30, 20, 25, 25]}, {"type": "plot", "title": "Work vs. Displacement", "expr": "F * x * cos(theta)", "x_range": [0, 10, 0.1], "y_range": [0, 100, 10]}, {"type": "bullets", "title": "Summary", "items": ["Work and energy describe how forces cause motion.", "Understanding these principles helps analyze physical systems."]}] at build time.
"""
...
class Lesson(Scene):
    def construct(self):
        slides = [{"type": "title", "text": "Work and Energy: Fundamental Concepts"}, {"type": "bullets", "title": "Objectives", "items": ["Understand the concept of work and its relation to force and displacement.", "Differentiate between types of forces and their roles in work.", "Apply the work-energy principle in mechanics."]}, {"type": "two_column", "left_title": "Work", "left": "Work is done when a force causes an object to move in the direction of the force.", "right_title": "Energy", "right": "Energy is the capacity to do work."}, {"type": "bullets", "title": "Key Concepts", "items": ["Work: Force causing movement.", "Energy: Capacity to do work.", "Force: Push or pull causing acceleration."]}, {"type": "equation", "title": "Work Formula", "lines": ["W = F \\cdot d = Fd \\cos \\theta"]}, {"type": "figure", "title": "Force and Displacement", "caption": "Illustration of force applied at an angle to displacement."}, {"type": "bar", "title": "Types of Forces", "labels": ["Gravitational", "Frictional", "Applied", "Normal"], "values": [30, 20, 25, 25]}, {"type": "plot", "title": "Work vs. Displacement", "expr": "F * x * cos(theta)", "x_range": [0, 10, 0.1], "y_range": [0, 100, 10]}, {"type": "bullets", "title": "Summary", "items": ["Work and energy describe how forces cause motion.", "Understanding these principles helps analyze physical systems."]}]  # list[dict] injected by generator

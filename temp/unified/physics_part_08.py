...
The generator injects a JSON list into [{"type": "title", "text": "Conservation of Energy: A Powerful Principle"}, {"type": "bullets", "title": "Objectives", "items": ["Understand energy conservation in mechanical systems.", "Differentiate between kinetic, gravitational potential, and elastic potential energy.", "Apply conservation of energy to solve physics problems."]}, {"type": "two_column", "left_title": "Kinetic Energy", "left": "Energy due to motion: KE = ½mv²", "right_title": "Gravitational Potential Energy", "right": "Energy due to position: PE_g = mgh"}, {"type": "two_column", "left_title": "Elastic Potential Energy", "left": "Energy in springs: PE_s = ½kx²", "right_title": "Conservation of Energy", "right": "Total energy remains constant: E = KE + PE"}, {"type": "equation", "title": "Energy Conservation Formula", "lines": ["E = KE + PE = \\text{constant}"]}, {"type": "plot", "title": "Energy Transformation", "expr": "0.5*m*v**2 + m*g*h", "x_range": [0, 10, 0.1], "y_range": [0, 100, 1]}, {"type": "bar", "title": "Energy Types Comparison", "labels": ["Kinetic", "Gravitational", "Elastic"], "values": [50, 30, 20]}, {"type": "figure", "title": "Energy in a Pendulum", "caption": "Illustration of energy conversion between kinetic and potential energy in a pendulum."}, {"type": "bullets", "title": "Summary", "items": ["Conservation of energy simplifies mechanical analysis.", "Focus on energy transformations.", "Makes complex problems manageable."]}] at build time.
"""
...
class Lesson(Scene):
    def construct(self):
        slides = [{"type": "title", "text": "Conservation of Energy: A Powerful Principle"}, {"type": "bullets", "title": "Objectives", "items": ["Understand energy conservation in mechanical systems.", "Differentiate between kinetic, gravitational potential, and elastic potential energy.", "Apply conservation of energy to solve physics problems."]}, {"type": "two_column", "left_title": "Kinetic Energy", "left": "Energy due to motion: KE = ½mv²", "right_title": "Gravitational Potential Energy", "right": "Energy due to position: PE_g = mgh"}, {"type": "two_column", "left_title": "Elastic Potential Energy", "left": "Energy in springs: PE_s = ½kx²", "right_title": "Conservation of Energy", "right": "Total energy remains constant: E = KE + PE"}, {"type": "equation", "title": "Energy Conservation Formula", "lines": ["E = KE + PE = \\text{constant}"]}, {"type": "plot", "title": "Energy Transformation", "expr": "0.5*m*v**2 + m*g*h", "x_range": [0, 10, 0.1], "y_range": [0, 100, 1]}, {"type": "bar", "title": "Energy Types Comparison", "labels": ["Kinetic", "Gravitational", "Elastic"], "values": [50, 30, 20]}, {"type": "figure", "title": "Energy in a Pendulum", "caption": "Illustration of energy conversion between kinetic and potential energy in a pendulum."}, {"type": "bullets", "title": "Summary", "items": ["Conservation of energy simplifies mechanical analysis.", "Focus on energy transformations.", "Makes complex problems manageable."]}]  # list[dict] injected by generator

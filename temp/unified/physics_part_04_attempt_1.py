...
The generator injects a JSON list into [{"type": "title", "text": "Newton's Laws of Motion: Foundations of Mechanics"}, {"type": "bullets", "title": "Objectives", "items": ["Understand the concept of inertia and its implications.", "Comprehend Newton's Second Law and its mathematical representation.", "Apply Newton's Laws to solve real-world physics problems."]}, {"type": "two_column", "left_title": "Key Concept: Inertia", "left": "The tendency of an object to resist changes in its state of motion.", "right_title": "Key Concept: Newton's Second Law", "right": "The acceleration of an object is directly proportional to the net force acting on it and inversely proportional to its mass."}, {"type": "equation", "title": "Newton's Second Law", "lines": ["F_{net} = ma"]}, {"type": "plot", "title": "Force vs. Acceleration", "expr": "F_net = m * a", "x_range": [0, 10, 0.1], "y_range": [0, 100, 1]}, {"type": "bar", "title": "Force Impact on Different Masses", "labels": ["1 kg", "2 kg", "3 kg"], "values": [10, 20, 30]}, {"type": "figure", "title": "Real-World Application", "caption": "Illustration of a car accelerating due to applied force."}, {"type": "bullets", "title": "Summary", "items": ["Newton's Laws provide a framework for understanding motion.", "Predict and analyze object behavior in various contexts."]}] at build time.
"""
...
class Lesson(Scene):
    def construct(self):
        slides = [{"type": "title", "text": "Newton's Laws of Motion: Foundations of Mechanics"}, {"type": "bullets", "title": "Objectives", "items": ["Understand the concept of inertia and its implications.", "Comprehend Newton's Second Law and its mathematical representation.", "Apply Newton's Laws to solve real-world physics problems."]}, {"type": "two_column", "left_title": "Key Concept: Inertia", "left": "The tendency of an object to resist changes in its state of motion.", "right_title": "Key Concept: Newton's Second Law", "right": "The acceleration of an object is directly proportional to the net force acting on it and inversely proportional to its mass."}, {"type": "equation", "title": "Newton's Second Law", "lines": ["F_{net} = ma"]}, {"type": "plot", "title": "Force vs. Acceleration", "expr": "F_net = m * a", "x_range": [0, 10, 0.1], "y_range": [0, 100, 1]}, {"type": "bar", "title": "Force Impact on Different Masses", "labels": ["1 kg", "2 kg", "3 kg"], "values": [10, 20, 30]}, {"type": "figure", "title": "Real-World Application", "caption": "Illustration of a car accelerating due to applied force."}, {"type": "bullets", "title": "Summary", "items": ["Newton's Laws provide a framework for understanding motion.", "Predict and analyze object behavior in various contexts."]}]  # list[dict] injected by generator

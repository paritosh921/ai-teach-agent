...
The generator injects a JSON list into [{"type": "title", "text": "Newton's Laws of Motion: An Overview"}, {"type": "bullets", "title": "Objectives", "items": ["Understand the concept of inertia and its role in motion.", "Comprehend Newton's Second Law and its mathematical formulation.", "Apply Newton's Laws to solve basic physics problems."]}, {"type": "two_column", "left_title": "Inertia", "left": "The tendency of an object to resist changes in its state of motion.", "right_title": "Newton's First Law", "right": "An object at rest stays at rest, and an object in motion stays in motion at constant velocity unless acted upon by a net external force."}, {"type": "equation", "title": "Newton's Second Law", "lines": ["F_{net} = ma"]}, {"type": "bullets", "title": "Key Concepts", "items": ["Inertia: Resistance to change in motion.", "Newton's First Law: Law of Inertia.", "Newton's Second Law: F = ma."]}, {"type": "plot", "title": "Force vs. Acceleration", "expr": "F_net = m * a", "x_range": [0, 10, 1], "y_range": [0, 100, 10]}, {"type": "bar", "title": "Force Comparison", "labels": ["Object 1", "Object 2", "Object 3"], "values": [10, 20, 30]}, {"type": "figure", "title": "Newton's Laws in Action", "caption": "Illustration of forces acting on a moving object."}, {"type": "bullets", "title": "Summary", "items": ["Newton's Laws provide a framework for motion.", "Inertia and force are key concepts.", "Essential for analyzing physical phenomena."]}] at build time.
"""
...
class Lesson(Scene):
    def construct(self):
        slides = [{"type": "title", "text": "Newton's Laws of Motion: An Overview"}, {"type": "bullets", "title": "Objectives", "items": ["Understand the concept of inertia and its role in motion.", "Comprehend Newton's Second Law and its mathematical formulation.", "Apply Newton's Laws to solve basic physics problems."]}, {"type": "two_column", "left_title": "Inertia", "left": "The tendency of an object to resist changes in its state of motion.", "right_title": "Newton's First Law", "right": "An object at rest stays at rest, and an object in motion stays in motion at constant velocity unless acted upon by a net external force."}, {"type": "equation", "title": "Newton's Second Law", "lines": ["F_{net} = ma"]}, {"type": "bullets", "title": "Key Concepts", "items": ["Inertia: Resistance to change in motion.", "Newton's First Law: Law of Inertia.", "Newton's Second Law: F = ma."]}, {"type": "plot", "title": "Force vs. Acceleration", "expr": "F_net = m * a", "x_range": [0, 10, 1], "y_range": [0, 100, 10]}, {"type": "bar", "title": "Force Comparison", "labels": ["Object 1", "Object 2", "Object 3"], "values": [10, 20, 30]}, {"type": "figure", "title": "Newton's Laws in Action", "caption": "Illustration of forces acting on a moving object."}, {"type": "bullets", "title": "Summary", "items": ["Newton's Laws provide a framework for motion.", "Inertia and force are key concepts.", "Essential for analyzing physical phenomena."]}]  # list[dict] injected by generator

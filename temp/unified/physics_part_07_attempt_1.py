...
The generator injects a JSON list into [{"type": "title", "text": "Kinetic and Potential Energy: Forms of Energy"}, {"type": "bullets", "title": "Objectives", "items": ["Understand kinetic and potential energy.", "Apply the work-energy theorem.", "Visualize energy transformations."]}, {"type": "two_column", "left_title": "Kinetic Energy", "left": "Energy due to motion. KE = ½mv²", "right_title": "Potential Energy", "right": "Energy due to position or configuration."}, {"type": "equation", "title": "Kinetic Energy Formula", "lines": ["KE = \\frac{1}{2}mv^2"]}, {"type": "equation", "title": "Work-Energy Theorem", "lines": ["W_{net} = \\Delta KE"]}, {"type": "plot", "title": "Energy vs. Velocity", "expr": "0.5*m*x**2", "x_range": [0, 10, 0.1], "y_range": [0, 500, 10]}, {"type": "bar", "title": "Energy Types Comparison", "labels": ["Kinetic", "Potential"], "values": [60, 40]}, {"type": "figure", "title": "Energy Transformation", "caption": "Illustration of energy transformation in a pendulum."}, {"type": "bullets", "title": "Key Concepts", "items": ["Kinetic Energy: Energy of motion.", "Potential Energy: Stored energy.", "Work-Energy Theorem: Net work equals change in kinetic energy."]}, {"type": "bullets", "title": "Summary", "items": ["Kinetic and potential energy describe motion and storage.", "Work-energy theorem aids in analyzing transformations."]}] at build time.
"""
...
class Lesson(Scene):
    def construct(self):
        slides = [{"type": "title", "text": "Kinetic and Potential Energy: Forms of Energy"}, {"type": "bullets", "title": "Objectives", "items": ["Understand kinetic and potential energy.", "Apply the work-energy theorem.", "Visualize energy transformations."]}, {"type": "two_column", "left_title": "Kinetic Energy", "left": "Energy due to motion. KE = ½mv²", "right_title": "Potential Energy", "right": "Energy due to position or configuration."}, {"type": "equation", "title": "Kinetic Energy Formula", "lines": ["KE = \\frac{1}{2}mv^2"]}, {"type": "equation", "title": "Work-Energy Theorem", "lines": ["W_{net} = \\Delta KE"]}, {"type": "plot", "title": "Energy vs. Velocity", "expr": "0.5*m*x**2", "x_range": [0, 10, 0.1], "y_range": [0, 500, 10]}, {"type": "bar", "title": "Energy Types Comparison", "labels": ["Kinetic", "Potential"], "values": [60, 40]}, {"type": "figure", "title": "Energy Transformation", "caption": "Illustration of energy transformation in a pendulum."}, {"type": "bullets", "title": "Key Concepts", "items": ["Kinetic Energy: Energy of motion.", "Potential Energy: Stored energy.", "Work-Energy Theorem: Net work equals change in kinetic energy."]}, {"type": "bullets", "title": "Summary", "items": ["Kinetic and potential energy describe motion and storage.", "Work-energy theorem aids in analyzing transformations."]}]  # list[dict] injected by generator

...
The generator injects a JSON list into [{"type": "title", "text": "Slides IR Demo"}, {"type": "bullets", "title": "Learning Objectives", "items": ["Big readable bullets", "Adaptive pagination", "Varied slide types"]}, {"type": "two_column", "left_title": "Continuity", "left": "Limit equals value at point.", "right_title": "Summary", "right": "Readable, varied slides."}, {"type": "equation", "title": "Key Equations", "lines": ["\\lim_{x\\to a} f(x) = L", "W = Fd \\cos \\theta"]}, {"type": "figure", "title": "Diagram", "caption": "Readable, varied slides."}] at build time.
"""
...
class Lesson(Scene):
    def construct(self):
        slides = [{"type": "title", "text": "Slides IR Demo"}, {"type": "bullets", "title": "Learning Objectives", "items": ["Big readable bullets", "Adaptive pagination", "Varied slide types"]}, {"type": "two_column", "left_title": "Continuity", "left": "Limit equals value at point.", "right_title": "Summary", "right": "Readable, varied slides."}, {"type": "equation", "title": "Key Equations", "lines": ["\\lim_{x\\to a} f(x) = L", "W = Fd \\cos \\theta"]}, {"type": "figure", "title": "Diagram", "caption": "Readable, varied slides."}]  # list[dict] injected by generator
